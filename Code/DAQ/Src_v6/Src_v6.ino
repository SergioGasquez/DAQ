...
void loop()
{
  ...
  for (counter = 0; counter < 10; counter++)  // Ramp
  {
    ...
    Serial.print(" "); Serial.print(dacVal);
    ...
    Serial.print(" "); Serial.print(valADC_A0);
    voltage = (valADC_A0 * 0.1875) / 1000;
    //Serial.print("\t voltage: "); Serial.print(voltage);

    valADC_A1 = ads.readADC_SingleEnded(1); // We read from the adc and normalize the voltage
    //Serial.print("\t valADC_A1: "); Serial.print(valADC_A1);
    Serial.print(" "); Serial.println(valADC_A1);
    voltage = (valADC_A1 * 0.1875) / 1000;
