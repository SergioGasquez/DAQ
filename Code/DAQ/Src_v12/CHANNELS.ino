...
void measureChannels()
{
  ...
  {
    //valSMU = readADC(0);
    //Serial.print("SMU: "); Serial.print(valSMU); Serial.print("Vol SMU: "); Serial.println(float(valSMU * 0.1875 / 1000));
  }
  if (ADC_2)
  {
    valADC_2 = readADC(2);
    Serial.print("ADC_2: "); Serial.println(valADC_2); //Serial.print("Vol ADC_2: "); Serial.println(float(ADC_2 * 0.1875 / 1000));
  }
  if (ADC_3)
  {
    valADC_3 = readADC(3);
  ...
  if (ARDU_A8)
  {
    ...
    Serial.print("valArdu_A8: "); Serial.println(valArdu_A8); //Serial.print("Vol Ardu_A8: "); Serial.println(float(valArdu_A8 * 0.1875 / 1000));
  }
  if (ARDU_A9)
  {
